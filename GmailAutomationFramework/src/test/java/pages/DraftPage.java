...
public class DraftPage extends AbstractPage {
	...
	public boolean checkMessageContent(String message, String subject,
			String address) {
		messageLabel.click();
		wait.waitForElementIsVisible(messageText);
		subject.equals(subjectText.getText());
		address.equals(addressText.getText());
		System.out.println("Content is the same.");
		return message.equals(messageText.getText());
	}
